...
for j=1:length(a)
    ...
    morsebokstav=inputmap(a(j)) % putter ut hver bokstav, sånn at vi kan jobbe med den
...
values(inputmap,mat2cell(a,1,ones(1,size(a,2))))    %mat2cell lånt fra http://www.mathworks.com/matlabcentral/newsreader/view_thread/156758
